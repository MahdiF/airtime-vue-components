<template>
    ...
    <div class="settings_cont" v-if="settingsShown">
      ...
      <div class="animation_type">
        ...
        <div class="animation_type_option">
          <input type="radio" id="scaleFadeAnim" name="animation_type" value="0" v-model="animationType">
          <label for="scaleFadeAnim">💥 Scale and fade in</label>
        </div>
        <div class="animation_type_option">
          <input type="radio" id="slideInAnim" name="animation_type" value="1" v-model="animationType">
          <label for="slideInAnim">➡️ Slide in from the side</label>
        </div>
        <div class="animation_type_option">
          <input type="radio" id="scalInPlaceAnim" name="animation_type" value="2" v-model="animationType">
  ...
  <div class="chat_wrapper" ref="chatWrapper">
    <div class="chat_timeline">
      <div
        ...
        :key="index"
        :class="[{msg_bubble : !message.color, 'msg_bubble msg_bubble_purple' : message.color},]"
  ...
  <div class="bottomBar">
    <input type="text" v-model="msgSent" @keyup.enter="sendMsg(false)" placeholder="Send a message...">
    <input type="text" v-model="msgReceived" @keyup.enter="sendMsg(true)" placeholder="Receive a message...">
  </div>
</div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      animationStyle: [
        {
          left: {animation: "scaleUp 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"},
          right: {animation: "scaleUpRight 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"}
        },
        {
          left: {animation: "slideIn 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"},
          right: {animation: "slideInRight 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"}
        },
        {
          left: {animation: "scaleInPlace 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"},
          right: {animation: "scaleInPlace 0.2s cubic-bezier(0.68, -0.55, 0.27, 1.55) forwards"}
        },
      ],
      activeStyle: "",
      activeStyleRight: "",
